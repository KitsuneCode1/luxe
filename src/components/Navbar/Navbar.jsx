        ...
        <div className="container">
          <div className="flex items-center justify-between py-2">
            <button className="flex gap-4 items-center justify-center">
              ...
              <div className="grid">
                <p className="tracking-wide font-bold text-sm mb-0">
                  LUXE
                </p>
            ...
            <div className="flex items-center gap-1 text-base ">
              <a
                href="#home"
                className="flex items-center font-semibold text-gray-800 px-3.5 py-3 hover:bg-gray-100 border border-transparent hover:border-gray-200 rounded-full hover:text-black transition-all ease-in-out duration-300"
              >
                Home
              </a>
